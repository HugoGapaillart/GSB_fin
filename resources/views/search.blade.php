...
<form action="{{ route('research') }}" class="d-flex mr-3">
    ...
    <input type="text" name="s" class="input input-bordered w-full max-w-xs" value="{{ request()->s ?? '' }}" placeholder="Rechercher un visiteur"> <!--Permet de créer la barre de recherche-->
